...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new GetAPIData().execute("https://api.covid19api.com/live/country/malawi/status/confirmed");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.privacy_menu){
            goLegal.putExtra("Source","Privacy");
            startActivity(goLegal);
        }

        if (id == R.id.terms_menu){
            goLegal.putExtra("Source","Terms");
            startActivity(goLegal);
